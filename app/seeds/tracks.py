...
def seed_tracks(hun, kevin, collin, demo):
    ...
    tracks = [
    # collin
        Track(artist_id = 3, album_id = 1, title = 'Data drive', duration = 300, genre = 'EDM', track_number = 1, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Digital dreams', duration = 291, genre = 'EDM', track_number = 2, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Code Jam', duration = 201, genre = 'Pop', track_number = 3, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Syntax Symphony', duration = 224, genre = 'Pop', track_number = 4, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Binary Boogie', duration = 196, genre = 'Pop', track_number = 5, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Byte-sized Beats', duration = 213, genre = 'Pop', track_number = 6, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 3, album_id = 1, title = 'Loop Logic', duration = 198, genre = 'Pop', track_number = 7, url = test_track_url, preview_image_url = test_image_url ),
    ...
    # kevin
        Track(artist_id = 2, album_id = 3, title = 'Genesis', duration = 234, genre = 'EDM', track_number = 1, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 2, album_id = 4, title = 'Technologic', duration = 284, genre = 'EDM', track_number = 2, url = test_track_url, preview_image_url = test_image_url),

    # hun
        Track(artist_id = 1, album_id = 2, title = "World's smallest violin", duration = 240, genre = 'Pop', track_number = 1, url = test_track_url, preview_image_url = test_image_url),
        Track(artist_id = 1, album_id = 2, title = "Bang!", duration = 171, genre = 'Pop', track_number = 2, url = test_track_url, preview_image_url = test_image_url)
        ]
